...
testChanged(with_('_.capitalize(foo)'), with_('_.upperFirst(foo)'));
...
testChanged(with_('_.each(a, b)'), with_('_.forEach(a, b)'));
testChanged(with_('_.eachRight(a, b)'), with_('_.forEachRight(a, b)'));
testChanged(with_('_.extend(a, b)'), with_('_.assignIn(a, b)'));
